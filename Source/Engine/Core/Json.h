...
#define READ_NAME_DATA(value, name, data) bunny::Json::Read(value, name, data)
#define READ_NAME_DATA_REQUIRED(value, name, data) bunny::Json::Read(value, name, data, true)
